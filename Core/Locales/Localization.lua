...
BINDING_NAME_DEVS_TOGGLE_DEBUG_CONSOLE     = L['BINDING_NAME_DEVS_TOGGLE_DEBUG_CONSOLE']
BINDING_NAME_DEVS_DUMP_CURSOR_INFO         = L['BINDING_NAME_DEVS_DUMP_CURSOR_INFO']
BINDING_NAME_DEVS_TOGGLE_SHOW_EVENT_TRACE_UI_AT_STARTUP = L['BINDING_NAME_DEVS_TOGGLE_SHOW_EVENT_TRACE_UI_AT_STARTUP']
