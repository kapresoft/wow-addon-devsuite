...
L['Accept']                  = true
L['Accept::Desc']            = 'Evaluates the code above.'
L['Accept and Reload UI']    = true
L['Accept and Reload UI::Desc'] = 'Evaluates the code above, then reloads the UI immediately (no confirmation).'

L['Debug Frame']             = true
L['Evaluate a variable or return a function'] = true
L['History:']                = true
L['Output:']                 = true
L['ERROR']                   = true
